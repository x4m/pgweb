...
urlpatterns = [
    ...
    re_path(r'^org/badges/edit/(\d+)/$', pgweb.account.views.org_badge_edit),
    re_path(r'^org/claims/$', pgweb.account.views.org_claims_list),
    re_path(r'^org/claims/review/(\d+)/$', pgweb.account.views.org_claim_review),
